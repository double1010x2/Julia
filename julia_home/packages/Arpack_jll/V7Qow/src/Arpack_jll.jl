...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Arpack_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("68821587-b530-5797-8361-c406ea357684"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Arpack", artifacts_toml) for e in artifacts["Arpack"]]
...
if best_platform === nothing
    @debug("Unable to load Arpack; unsupported platform $(triplet(platform_key_abi()))")
else
